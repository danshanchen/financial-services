...
**Default assumption: the agent is already very capable.** Only add context the agent doesn'''t already have. Challenge each piece of information: "Does the model really need this explanation?" and "Does this paragraph justify its token cost?"
